...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_REGULATOR_NXP_VREF_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_REGULATOR_NXP_VREF_H_
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_REGULATOR_NXP_VREF_H_ */
