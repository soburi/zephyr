 ...
 */
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_SENSOR_LSM6DSO_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_SENSOR_LSM6DSO_H_
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_SENSOR_LSM6DSO_H_ */
