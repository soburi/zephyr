...
struct cfb_display_init_param {
	...
	/** Pointer to a transfer buffer */
	uint8_t *transfer_buf;

	/** Size of the transfer buffer */
	uint32_t transfer_buf_size;

	/** Pointer to a command buffer */
	uint8_t *command_buf;
 ...
 * @retval -errno Negative errno for other failures.
 */
static inline int cfb_print(struct cfb_framebuffer *fb, const char *const str, int16_t x,
			    int16_t y)
{
 ...
 * @retval -errno Negative errno for other failures.
 */
static inline int cfb_draw_text_ref(struct cfb_framebuffer *fb, const char *const str,
				    int16_t x, int16_t y)
{
 ...
 * @return 0 on success, negative value otherwise
 */
static inline int cfb_invert_area(struct cfb_framebuffer *fb, int16_t x, int16_t y,
 ...
 * @retval -errno  Negative errno for other failures.
 */
static inline int cfb_set_fg_color(struct cfb_framebuffer *fb, uint8_t r, uint8_t g,
				   uint8_t b, uint8_t a)
{
 ...
 * @retval -errno  Negative errno for other failures.
 */
static inline int cfb_set_bg_color(struct cfb_framebuffer *fb, uint8_t r, uint8_t g,
				   uint8_t b, uint8_t a)
{
