 ...
 * @retval -errno  Negative errno for other failures.
 */
static inline int cfb_set_fg_color(const struct cfb_framebuffer *fb, uint8_t r, uint8_t g, uint8_t b,
				   uint8_t a)
{
 ...
 * @retval -errno  Negative errno for other failures.
 */
static inline int cfb_set_bg_color(const struct cfb_framebuffer *fb, uint8_t r, uint8_t g, uint8_t b,
				   uint8_t a)
{
