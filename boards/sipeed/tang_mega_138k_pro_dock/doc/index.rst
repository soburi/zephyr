.. zephyr:board:: tang_mega_138k_pro_dock
...
The :zephyr:board:`tang_mega_138k_pro_dock/ae350/demo` configuration supports the peripherals enabled by the
...
For the :zephyr:board:`tang_mega_138k_pro_dock/ae350/demo` variant, build the ``ae350_demo.fs`` image from
...
.. zephyr-app-commands::
   ...
   :board: tang_mega_138k_pro_dock/ae350/demo
   :goals: build flash
...
The default :zephyr:board:`tang_mega_138k_pro_dock/ae350/demo` configuration uses XIP. Flash the application
