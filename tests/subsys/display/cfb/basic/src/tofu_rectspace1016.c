...
LOG_MODULE_REGISTER(tofu_rectspace1016, CONFIG_DISPLAY_LOG_LEVEL);
 ...
 * normal rendering
 */
ZTEST(tofu_rectspace1016, test_tofu_at_0_0)
{
...
ZTEST(tofu_rectspace1016, test_tofu_at_1_1)
{
 ...
 * around tile border
 */
ZTEST(tofu_rectspace1016, test_tofu_at_9_15)
{
...
ZTEST(tofu_rectspace1016, test_tofu_at_10_16)
{
...
ZTEST(tofu_rectspace1016, test_tofu_at_11_17)
{
 ...
 * with kerning
 */
ZTEST(tofu_rectspace1016, test_tofu_at_0_0_kerning_3)
{
...
ZTEST(tofu_rectspace1016, test_tofu_at_1_1_kerning_3)
{
	cfb_set_kerning(dev, 3);
	zassert_ok(cfb_draw_text(dev, "  ", 1, 1));
	zassert_ok(cfb_framebuffer_finalize(dev));
...
ZTEST(tofu_rectspace1016, test_tofu_at_9_15_kerning_3)
{
	cfb_set_kerning(dev, 3);
	zassert_ok(cfb_draw_text(dev, "  ", 9, 15));
	zassert_ok(cfb_framebuffer_finalize(dev));
...
ZTEST(tofu_rectspace1016, test_tofu_at_10_16_kerning_3)
{
	cfb_set_kerning(dev, 3);
	zassert_ok(cfb_draw_text(dev, "  ", 10, 16));
	zassert_ok(cfb_framebuffer_finalize(dev));
...
ZTEST(tofu_rectspace1016, test_tofu_at_11_17_kerning_3)
{
	cfb_set_kerning(dev, 3);
	zassert_ok(cfb_draw_text(dev, "  ", 11, 17));
	zassert_ok(cfb_framebuffer_finalize(dev));
...
ZTEST(tofu_rectspace1016, test_tofu_kerning_3_within_right_border)
{
	cfb_set_kerning(dev, 3);
...
ZTEST(tofu_rectspace1016, test_tofu_kerning_3_over_right_border)
{
	cfb_set_kerning(dev, 3);
...
ZTEST(tofu_rectspace1016, test_tofu_outside_top_left)
{
...
ZTEST(tofu_rectspace1016, test_tofu_outside_top_right)
{
...
ZTEST(tofu_rectspace1016, test_tofu_outside_bottom_right)
{
...
ZTEST(tofu_rectspace1016, test_tofu_outside_bottom_left)
{
...
ZTEST_SUITE(tofu_rectspace1016, NULL, NULL, cfb_test_before, cfb_test_after, NULL);
