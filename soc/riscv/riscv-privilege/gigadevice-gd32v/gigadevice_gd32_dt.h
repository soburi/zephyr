...
/** @file
 * @brief ST GD32 MCU family devicetree helper macros
 */

#ifndef _ST_GD32_DT_H_
#define _ST_GD32_DT_H_
 ...
 * @return pincfg field
 */
#ifndef CONFIG_SOC_SERIES_GD32F1X
#define GIGADEVICE_GD32_DT_INST_PINCFG(inst, x, i)				       \
	(((GD32_NO_PULL * GIGADEVICE_GD32_DT_INST_FUNC(inst, x, i, bias_disable))      \
	 ...
	 ((GD32_OPEN_DRAIN * GIGADEVICE_GD32_DT_INST_FUNC(inst, x, i,		       \
							  drive_open_drain))	       \
		<< GD32_OTYPER_SHIFT) |						       \
	 (GIGADEVICE_GD32_DT_INST_SLEW_RATE(inst, x, i) << GD32_OSPEEDR_SHIFT))
#else
#define GIGADEVICE_GD32_DT_INST_PINCFG(inst, x, i)				       \
	(((GD32_NO_PULL * GIGADEVICE_GD32_DT_INST_FUNC(inst, x, i, bias_disable))      \
		<< GD32_PUPD_SHIFT) |						       \
...
#define GIGADEVICE_GD32_DT_PINCFG(name, x, i)					    \
	(((GD32_NO_PULL * GIGADEVICE_GD32_DT_FUNC(name, x, i, bias_disable))	    \
	 ...
	 ((GD32_OPEN_DRAIN * GIGADEVICE_GD32_DT_FUNC(name, x, i, drive_open_drain)) \
		<< GD32_OTYPER_SHIFT) |						    \
	 (GIGADEVICE_GD32_DT_SLEW_RATE(name, x, i) << GD32_OSPEEDR_SHIFT))
#else
#define GIGADEVICE_GD32_DT_PINCFG(name, x, i)					    \
	(((GD32_NO_PULL * GIGADEVICE_GD32_DT_FUNC(name, x, i, bias_disable))	    \
		<< GD32_PUPD_SHIFT) |						    \
