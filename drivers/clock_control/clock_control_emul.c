...
__maybe_unused static bool zephyr_clock_controller_emul_subsys_match(clock_control_subsys_t sys,
...
zephyr_clock_controller_emul_subsys_rate_to_value(clock_control_subsys_rate_t rate, uint32_t *value)
{
