...
struct gpio_rpi_config {
	...
	DEVICE_MMIO_NAMED_ROM(REGNAME_SIO_RIO);
...
struct gpio_rpi_data {
	...
	DEVICE_MMIO_NAMED_RAM(REGNAME_SIO_RIO);
...
static int gpio_rpi_bank_init(const struct device *dev)
{
	...
	DEVICE_MMIO_NAMED_MAP(dev, REGNAME_SIO_RIO, K_MEM_CACHE_NONE);
...
#define GPIO_RPI_COMMON_INIT(node_id)                                                              \
	...
	static const struct gpio_rpi_config gpio_rpi_##node_id##_config = {                        \
		...
		DEVICE_MMIO_NAMED_ROM_INIT_BY_NAME(gpio, DT_PARENT(node_id)),                      \
		DEVICE_MMIO_NAMED_ROM_INIT_BY_NAME(pads, DT_PARENT(node_id)),                      \
		DEVICE_MMIO_NAMED_ROM_INIT_BY_NAME(REGNAME_SIO_RIO, DT_PARENT(node_id)),           \
