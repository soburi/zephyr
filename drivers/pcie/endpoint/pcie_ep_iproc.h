...
#define MSIX_VECTOR_OFF(x)       (MSIX_TABLE_BASE + (MSIX_TBL_ENTRY_SIZE * (x)))
...
#if DT_INST_PROP(0, brcm_iproc_pcie_ep_v2)
...
#define AXI_FILTER_0_ENABLE                 (BIT(30) | BIT(2) | BIT(1) | BIT(0))
